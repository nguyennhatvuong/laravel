                ...
                createDropdown: function () {
                    ...
                    return (
                        ...
                        this.multiple &&
                            ...
                            (l =
                                '<div class="bs-actionsbox"><div class="btn-group btn-group-sm btn-block"><button type="button" class="actions-btn bs-select-all btn btn-primary">' +
                                this.options.selectAllText +
                                '</button><button type="button" class="actions-btn bs-deselect-all btn btn-danger">' +
